...
export function FiliaisLandingCaseStudies({ caseStudies, sx, ...other }: Props) {
  const renderTexts = () => (
    <Box sx={{ textAlign: { xs: "center", md: "unset" } }}>
      <Typography
        variant="overline"
        sx={{ mb: 3, display: "block", color: "text.disabled" }}
      >
        Our work
      </Typography>
  ...
  const renderContent = () => (
    <Box sx={{ display: "flex", flexDirection: "column", p: 3, pt: 5, width: 0.5 }}>
      ...
      <Button
        ...
        color="inherit"
        endIcon={
          <Iconify width={16} icon="solar:alt-arrow-right-outline" sx={{ ml: -0.5 }} />
        }
