...
export function FiliaisAbout({ sx, ...other }: BoxProps) {
  return (
    <Box
      component="section"
        ...
        >
          ...
          >
            ...
            <Typography sx={{ mt: 3, mb: 5, color: "text.secondary" }}>
              Vivamus consectetuer hendrerit lacus. Curabitur a felis in nunc fringilla
              tristique. Nulla neque dolor, sagittis eget, iaculis quis, molestie non,
              velit.
              <br />
              <br />
              Nam pretium turpis et arcu. Praesent porttitor, nulla vitae posuere iaculis,
              arcu nisl dignissim dolor, a pretium mi sem ut ipsum. Praesent venenatis
